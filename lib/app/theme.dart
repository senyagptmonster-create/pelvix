...
class AppTheme {
  static const Color cBg = Color(0xFF0E0D13);
  static const Color cSurface = Color(0xFF171520);
  static const Color cEdge = Color(0xFF242131);
  static const Color cAccent = Color(0xFFEAB308);
  static const Color cAccent2 = Color(0xFFFDE047);
  static const Color cInk = Color(0xFFFEFCE8);
